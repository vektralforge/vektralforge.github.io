...
(function () {
   ...
   var ES = {
      ...
      "hero.trust.selfhosted": "Autoalojada",
      ...
      "about.p2": "Cada paso de cada pipeline se traza automáticamente: de dónde vinieron los datos, qué los transformó y cuándo, y dónde terminaron. Ese linaje es una funcionalidad de primera clase, no un complemento que configuras después.",
      ...
      "arch.lede": "Spark escribe, Trino lee. Las operaciones ACID sobre Delta Lake — <code>MERGE</code>, <code>UPDATE</code>, <code>DELETE</code>, <code>VACUUM</code> — se ejecutan a través de Spark; Trino te da SQL interactivo sobre las mismas tablas mediante un Hive Metastore compartido, así que una tabla que escribe Spark es consultable desde Trino sin registrarla dos veces.",
      ...
      "feat.card1.h3": "Dos pipelines reales, sin credenciales",
      "feat.card1.p": "Indicadores financieros chilenos desde mindicador.cl y datos municipales de riesgo climático desde ARClim — ambas son APIs públicas, así que cualquiera que clone el repositorio puede ejecutar los pipelines completos sin registrarse en ningún lado.",
      ...
      "spon.p": "Una consultora de infraestructura TI con sede en Chile, Aleph Server creó VektralForge y financia su desarrollo continuo. El patrocinio compra visibilidad y gratitud — no compra un veto, un voto decisivo, ni un asiento reservado en el Comité Técnico Directivo.",
